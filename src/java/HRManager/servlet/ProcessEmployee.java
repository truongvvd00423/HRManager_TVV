...
import HRManager.bol.SalaryManagerBO;
        ...
        if (action != null && action.equals("delete")) {
            try {
                ...
                if (e == null) {
                    ...
                    if (ebo.delete(e) > 0) {
                        if (new SalaryManagerBO().delete(e.getEmployeeID()) == 0) response.sendRedirect("InformationPage.jsp?type=info&msg=This EmployeeID can't delete SalaryManagerBO");
            ...
            if (action.equals("edit")) {
                try {
                    ...
                    if (ebo.edit(e) > 0) {
                        if(new SalaryManagerBO().update(e.getEmployeeID(), 1) == Integer.parseInt(request.getParameter("txtSalaryLevel"))) response.sendRedirect("InformationPage.jsp?type=warning&msg=This EmployeeID can't delete SalaryManagerBO");
                ...
                if (ebo.add(e) > 0) {
                    if (new SalaryManagerBO().add(e.getEmployeeID()) == 0) response.sendRedirect("InformationPage.jsp?type=info&msg=This EmployeeID can't insert SalaryManagerBO");
                    response.sendRedirect("InformationPage.jsp?type=warning&msg=This EmployeeID inserted to database");
                } else {
